...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let oslow = Capital(title: "Oslo", coordinate: CLLocationCoordinate2D(latitude: 59.95, longitude: 10.75), info: "Founded over 1000 years ago")
...
//        present(ac, animated: true)
    ...
    @IBAction func infoButtonTapped(_ sender: UIButton) {
        ...
        ac.addAction(UIAlertAction(title: "Muted", style: .default, handler: setMapType))
