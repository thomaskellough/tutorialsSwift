...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        player1ScoreLabel.position = CGPoint(x: 140, y: 650)
        ...
        player2ScoreLabel.position = CGPoint(x: size.width - 140, y: 650)
        ...
        windLabel.fontSize = 24
        windLabel.text = "Wind: \(randomGravity)"
        windLabel.zPosition = 1
        windLabel.position = CGPoint(x: 600, y: 685)
    ...
    func launch(angle: Int, velocity: Int) {
        ...
        banana.physicsBody?.usesPreciseCollisionDetection = true // will also perform calculations between frames if objects are struct, very slow, don't enable often!
        addChild(banana)
        ...
        if currentPlayer == 1 {
            ...
            banana.physicsBody?.applyImpulse(impulse) // impulse means "give a push in specific direction
        } else {
    ...
    func destroy(player: SKSpriteNode) {
        ...
        if player.name == "player1" {
            ...
            if player2Score == 3 {
                ...
                player2ScoreLabel.text = "Player 2: \(player2Score)"
                defaults.set(player2Score, forKey: "Player2Score")
            }
        } else if player.name == "player2" {
            player1Score += 1
            if player1Score == 3 {
                gameOver(player: "Player 1")
            } else {
                player1ScoreLabel.text = "Player 1: \(player1Score)"
                defaults.set(player1Score, forKey: "Player1Score")
            }
        }
    ...
    func gameOver(player: String) {
        ...
        winnerLabel.text = "\(player.uppercased()) WINS!"
        winnerLabel.position = CGPoint(x: 512, y: 200)
